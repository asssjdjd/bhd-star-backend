                ...
                <div class="cart-wrapper">
                    <ul class="card-list swiper-wrapper" style="list-style: none;">
                        <li class="card-item swiper-slide ">
                            <img src="https://www.bhdstar.vn/wp-content/uploads/2025/04/referenceSchemeHeadOfficeallowPlaceHoldertrueheight700ldapp-15.jpg" alt="..." style="border-radius: 10px;">
                            <a href="#"
