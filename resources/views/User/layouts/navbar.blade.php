    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fw-bold">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @else
                    <li class="account-item has-icon nav-item  list-unstyled">
                        <a href="#" class="account-link account-login text-decoration-none " title="Tài khoản">
                            <i class="image-icon circle">
                                <img src="{{ asset('asset/img/no-user.jpg')}}">
                            </i>
                            <span class="header-account-title text-dark">
                                {{ Auth::user()->name . ' ' . Auth::user()->surname}} /
                            </span>
                        </a>
                        <a class="lougout-link text-decoration-none text-danger" href="{{ route('logout')}}">Thoát</a>
                    </li>
                @endif
            </div>
        </div>
